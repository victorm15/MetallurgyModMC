...
import net.victej.alloymod.screen.ForgeScreen;
import net.victej.alloymod.screen.ModMenuTypes;
import org.slf4j.Logger;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(AlloyMod.MOD_ID)
public class AlloyMod {
    public static final String MOD_ID = "alloymod";
